...
public class MusicController:ControllerBase
{
    ...
    public MusicController(IMapper _mapper, IProductService _ServiceProduct)
    {
        mapper= _mapper;
    ...
    public IActionResult CadastrarMusica([FromBody] CreateMusicDto music)
    {
        ...
        //_daoMusic.CadastrarMusicaNoBanco(MusicaNova);
    ...
    {
        //var ExcluirMusica = _daoMusic.ProcurarMusciaPeloTitle1(title);
        ...
        //  _daoMusic.RemoverMusic(ExcluirMusica);
        ServiceProduct.RemoverMusic(ExcluirMusica);
        return NoContent();
    }
}
